 ...
 * $Date: 2019-06-25 07:33:04 $
 *
 * $Id$
 */

#include "ConsoleInShort.h"
#include <iostream>
...
ConsoleInShort::ConsoleInShort(RTC::Manager* manager)
...
RTC::ReturnCode_t ConsoleInShort::onExecute(RTC::UniqueId  /*ec_id*/)
{
...
extern "C"
{
  ...
  void ConsoleInShortInit(RTC::Manager* manager)
  {
    RTC::Properties profile(consoleinshort_spec);
    manager->registerFactory(profile,
                             RTC::Create<ConsoleInShort>,
                             RTC::Delete<ConsoleInShort>);
  }
