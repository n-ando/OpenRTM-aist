...
/*!
 * @file SyncLIFO.h
 * @brief Synchronous LIFO Buffer class
 * @date $Date: 2007-09-21 09:25:28 $
 ...
 *     All rights reserved.
 *
 * $Id: SyncLIFO.h,v 1.1.2.1 2007-09-21 09:25:28 n-ando Exp $
 *
 */
...
namespace RTC
{
  ...
  public:
    ...
    {
      return m_buffer[(m_rend + m_size - 1) % m_size];
    }
