// -*- C++ -*-
/*!
 * @file   ModeProxyTests.cpp
 * @brief  ModeProxy test class
 * @date   $Date$ 
...
#ifndef ModeProxy_cpp
#define ModeProxy_cpp
...
/*!
 * @class ModeProxyTests class
 * @brief ModeProxy test
 */
namespace ModeProxy
{
  class Logger
  ...
  class ModeProxyTests
   : public CppUnit::TestFixture
  {
    CPPUNIT_TEST_SUITE(ModeProxyTests);
...
/*
    void test_set_service_profile()
    {
      ...
      ::SDOPackage::CORBA::ModeProxy* ap 
                 = new ::SDOPackage::CORBA::ModeProxy(ref);
 ...
 * Register test suite
 */
CPPUNIT_TEST_SUITE_REGISTRATION(ModeProxy::ModeProxyTests);
