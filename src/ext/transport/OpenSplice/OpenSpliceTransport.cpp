...
static const char* const opensplice_sub_option[] =
{
  ...
  "subscriber_qos.id.__value__", "",
  "subscriber_qos.id.__widget__", "text",
  "subscriber_qos.id.__constraint__", "none",
  ...
  "subscriber_qos.entity_factory.autoenable_created_entities.__value__", "YES",
  "subscriber_qos.entity_factory.autoenable_created_entities.__widget__", "radio",
  "subscriber_qos.entity_factory.autoenable_created_entities.__constraint__", "(YES, NO)",
  "subscriber_qos.presentation.access_scope.__value__", "TOPIC_PRESENTATION_QOS",
  "subscriber_qos.presentation.access_scope.__widget__", "radio",
  "subscriber_qos.presentation.access_scope.__constraint__", "(INSTANCE_PRESENTATION_QOS, TOPIC_PRESENTATION_QOS, GROUP_PRESENTATION_QOS)",
  "subscriber_qos.presentation.coherent_access.__value__", "YES",
  "subscriber_qos.presentation.coherent_access.__widget__", "radio",
  "subscriber_qos.presentation.coherent_access.__constraint__", "(YES, NO)",
  "subscriber_qos.presentation.ordered_access.__value__", "YES",
  "subscriber_qos.presentation.ordered_access.__widget__", "radio",
  "subscriber_qos.presentation.ordered_access.__constraint__", "(YES, NO)",
  "subscriber_qos.share.enable.__value__", "YES",
  "subscriber_qos.share.enable.__widget__", "radio",
  "subscriber_qos.share.enable.__constraint__", "(YES, NO)",
...
static const char* const opensplice_pub_option[] =
{
  ...
  "topic.__widget__", "text",
  "topic.__constraint__", "none",
  "publisher_qos.id.__value__", "",
  "publisher_qos.id.__widget__", "text",
  "publisher_qos.id.__constraint__", "none",
  ...
  "topic_qos.id.__widget__", "text",
  "topic_qos.id.__constraint__", "none",
  "publisher_qos.entity_factory.autoenable_created_entities.__value__", "YES",
  "publisher_qos.entity_factory.autoenable_created_entities.__widget__", "radio",
  "publisher_qos.entity_factory.autoenable_created_entities.__constraint__", "(YES, NO)",
  "publisher_qos.presentation.access_scope.__value__", "TOPIC_PRESENTATION_QOS",
  "publisher_qos.presentation.access_scope.__widget__", "radio",
  "publisher_qos.presentation.access_scope.__constraint__", "(INSTANCE_PRESENTATION_QOS, TOPIC_PRESENTATION_QOS, GROUP_PRESENTATION_QOS)",
  "publisher_qos.presentation.coherent_access.__value__", "YES",
  "publisher_qos.presentation.coherent_access.__widget__", "radio",
  "publisher_qos.presentation.coherent_access.__constraint__", "(YES, NO)",
  "publisher_qos.presentation.ordered_access.__value__", "YES",
  "publisher_qos.presentation.ordered_access.__widget__", "radio",
  "publisher_qos.presentation.ordered_access.__constraint__", "(YES, NO)",
