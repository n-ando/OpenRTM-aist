...
ace_pkg="http://dist.bonsai.com/ken/ace_tao_rpm/FC5.i386/5.5.1-4/ace-5.5.1-4.FC5.i386.rpm"
ace_devel_pkg="http://dist.bonsai.com/ken/ace_tao_rpm/FC5.i386/5.5.1-4/ace-devel-5.5.1-4.FC5.i386.rpm"
...
if test "x$ace" = "x" ; then
	...
	wget $ace_pkg
	echo "Installing ace...."
	rpm -ivh ace-5.5.1-4.FC5.i386.rpm
	echo "done"
else
...
if test "x$ace_devel" = "x" ; then
	...
	rpm -ivh ace-devel-5.5.1-4.FC5.i386.rpm
	echo "done"
else
