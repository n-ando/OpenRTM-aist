/*! -*- C++ -*-
 *
 * @file RtcRingBuffer.h
 * @brief Ring buffer template class
 * @date $Date: 2006-11-07 09:30:14 $
 ...
 *     All rights reserved.
 *
 * $Id: RingBuffer.h,v 1.2 2006-11-07 09:30:14 n-ando Exp $
 *
 */
...
#ifndef RtcRingBuffer_h
#define RtcRingBuffer_h
...
namespace RTM {
  ...
  public:
	...
	{
	  m_Buffer[m_Oldest].write(value);
	  
	  ACE_Guard<ACE_Thread_Mutex> guard(m_Mutex);
	  m_Newest = m_Oldest;
	  m_Oldest = (++m_Oldest) % m_Length;
